...
def main(args):
    ...
    train_dataset=SBI_Dataset(phase='train',image_size=image_size, raw = args.raw, sladd = True)
    val_dataset=SBI_Dataset(phase='val',image_size=image_size, raw = args.raw, sladd = True)
    ...
    # opt_sd = torch.load(args.weight_name)["optimizer"]
